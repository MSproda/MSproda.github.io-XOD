(() => {
    ...
    const msWrapper = document.querySelector(".ms--animation__content");
    const msLock = document.querySelector("body");
    const msAnimation = () => {
        setTimeout((() => {
            msWrapper.classList.add("ms--animation__active");
            setTimeout((() => {
                msWrapper.style.display = "none";
                msLock.style.overflow = "auto";
            }), 1500);
        }), 1e3);
    };
    const burger = document.querySelector("#_burgerSTX");
    const headerAsaide = document.querySelector(".header__asaide");
    burger.addEventListener("click", (e => {
        burger.classList.toggle("_burgerSTX-active");
        headerAsaide.classList.toggle("asaide-active");
    }));
    const headerMap = document.querySelector(".--map__svg");
    const asaideCity = document.querySelector(".header__asaide-city");
    const mobCity = document.querySelector(".city__wrapper");
    const mobLink = document.querySelector(".asaide__info-city");
    const cityLink = document.querySelectorAll(".city-link");
    const citySpan = document.querySelector(".city-span");
    const mobCityLink = document.querySelectorAll(".mobCity-link");
    const mobCitySpan = document.querySelector(".mobCity-span");
    const coursesItem = document.querySelectorAll(".courses__age-item");
    window.onload = e => {
        msAnimation();
        document.addEventListener("click", (e => {
            const trg = e.target;
            if (trg.classList.contains("--map__svg") || trg.classList.contains("info__span")) {
                headerMap.classList.toggle("--map__svg-active");
                asaideCity.classList.toggle("asaide__city-active");
            }
            if (trg.classList.contains("asaide__info-city") || trg.classList.contains("asaide__info-citySpan")) {
                mobCity.classList.toggle("city__wrapper--active");
                mobLink.classList.toggle("asaide__info-city--active");
            }
            for (let index = 0; index < cityLink.length; index++) {
                const el = cityLink[index];
                el.addEventListener("click", (e => {
                    citySpan.textContent = el.textContent;
                }));
            }
            for (let index = 0; index < mobCityLink.length; index++) {
                const el = mobCityLink[index];
                el.addEventListener("click", (e => {
                    mobCitySpan.textContent = el.textContent;
                }));
            }
        }));
    };
    coursesItem.forEach(((item, i, a) => {
        item.addEventListener("click", (() => a.forEach((m => m.classList.toggle("courses--active", m === item)))));
    }));
    ...
    const commentsContainer = document.querySelector(".slider");
    getComments();
    function getComments() {
        const commentsData = [ {
            img: "../img/Main/Comments/logo1.png",
            name: "Анна Алиева",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat. Curabitur pellentesque est bibendum urna facilisis varius. In hac habitasse platea dictumst. In ut dui sodales, scelerisque eros non, ultrices magna. ",
            rating: "3 / 5"
        }, {
            img: "../img/Main/Comments/logo2.png",
            name: "Мадина Магомедова",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat. Curabitur pellentesque est bibendum urna facilisis varius.",
            rating: "4.5 / 5"
        }, {
            img: "../img/Main/Comments/logo3.png",
            name: "Амелия Франк",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat. Curabitur pellentesque est bibendum urna facilisis varius. In hac habitasse platea dictumst. In ut dui sodales.",
            rating: "5 / 5"
        }, {
            img: "../img/Main/Comments/logo4.png",
            name: "Джози Барбара",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat!",
            rating: "2 / 5"
        }, {
            img: "../img/Main/Comments/logo5.png",
            name: "Наташа Амирова",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat. Curabitur pellentesque est bibendum urna facilisis varius. In hac habitasse platea dictumst. In ut dui sodales.",
            rating: "4.2 / 5"
        }, {
            img: "../img/Main/Comments/logo6.png",
            name: "Настя Рукеева",
            profession: "Студент курса «WEB-разработчик»",
            comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat nisl at augue dapibus, id tristique lorem placerat. Curabitur pellentesque est bibendum urna facilisis varius.",
            rating: "3.5 / 5"
    ...
    function renderComment(commentsData) {
        commentsData.forEach((function(item) {
            const comment = `<div class="slider--padding">\n        <div class="slider__item">\n            <div class="slider__user">\n                <div class="slider__user-img">\n                    <img src=${item.img} alt="logo">\n                </div>\n                <div class="slider__user-info">\n                    <span class="slider__user-name">${item.name}</span>\n                    <span class="slider__user-profession">${item.profession}</span>\n                </div>\n            </div>\n\n            <p class="slider__comment">${item.comment}</p>\n\n            <div class="slider__rating">\n                <img src="../img/Main/Comments/star.svg" alt="star">\n                <span>${item.rating}</span>\n            </div>\n        </div>\n        </div>`;
            commentsContainer && commentsContainer.insertAdjacentHTML("beforeend", comment);
        }));
    }
    const emailInput = document.querySelector(".email");
    const phoneInput = document.querySelector(".phone");
    if (emailInput) emailInput.onkeyup = validate;
    if (phoneInput) phoneInput.onkeyup = validate;
    const formBtn = document.querySelector(".form__action-btn");
    formBtn && formBtn.setAttribute("disabled", "disabled");
    const popupForm = document.querySelector(".form__popup");
    function validate() {
        const emailStyle = document.querySelector(".email__wrapper");
        const phoneStyle = document.querySelector(".phone__wrapper");
        const phone = document.querySelector(".phone").value;
        const email = document.querySelector(".email").value;
        const patternEmail = /^[^ ]+@[^ ]+\.[a-z]{2,3}$/;
        const patternPhone = /^[\d\+][\d\(\)\ -]{4,14}\d$/;
        email.match(patternEmail) ? emailStyle.classList.add("email__valid") : emailStyle.classList.remove("email__valid");
        phone.match(patternPhone) ? phoneStyle.classList.add("phone__valid") : phoneStyle.classList.remove("phone__valid");
        if (email.match(patternEmail) && phone.match(patternPhone)) {
    ...
    const fnFormBtn = () => {
        ...
        popupForm.classList.add("form__popup-active");
        setTimeout((() => {
            formBtn.classList.remove("form__btn-active");
            popupForm.classList.remove("form__popup-active");
        }), 2e3);
    };
    formBtn && formBtn.addEventListener("click", (e => {
        fnFormBtn();
    }));
    isWebp();
})();